...
public class BilletDAO {
    ...
    public void addBillet(Billet billet) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            statement.setObject(12, billet.getDuree());  // Assuming your database column is of type INTERVAL
    ...
    public List<Billet> getAllBillets() {
        ...
        try (Statement statement = connection.createStatement();
            ...
            while (resultSet.next()) {
                ...
                Duration duree = resultSet.getObject("duree", Duration.class);
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            if (resultSet.next()) {
                billet = new Billet(
                        ...
                        resultSet.getObject("duree", Duration.class)
                );
            }
        } catch (SQLException e) {
            e.printStackTrace();
    ...
    public void updateBillet(Billet billet) {
        ...
        try (PreparedStatement statement = connection.prepareStatement(query)) {
            ...
            statement.setObject(11, billet.getDuree());  // Assuming your database column is of type INTERVAL
